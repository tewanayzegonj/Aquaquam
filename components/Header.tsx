  ...
  return (
    <header className="h-20 bg-white dark:bg-donezo-card-dark border-b border-slate-100 dark:border-slate-800 flex items-center justify-between px-4 md:px-8 flex-shrink-0 z-20 relative">
      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        >
          {isDarkMode ? (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 4.657l-.707-.707m12.728 0l-.707.707M6.343 19.343l-.707.707M12 5a7 7 0 100 14 7 7 0 000-14z" /></svg>
          ) : (
